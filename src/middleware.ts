 ...
 * fine-grained RBAC via requireRole (including AdminProfile status). This
 * middleware adds the missing edge-level redirect so unauthenticated visitors
 * never reach the admin shell at all, instead of receiving an in-page error
 * with HTTP 200.
 *
