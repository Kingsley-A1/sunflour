  ...
  return (
    <div className="grid gap-2">
      ...
      <input
        ...
        className={cn(
          "min-h-[var(--control-height-md)] w-full min-w-0 max-w-full rounded-[var(--radius-sm)] border bg-[var(--color-surface-overlay)] px-3 text-[var(--color-text)] outline-none transition placeholder:text-[var(--color-text-soft)] disabled:border-[var(--color-disabled-border)] disabled:bg-[var(--color-disabled-bg)] disabled:text-[var(--color-disabled-text)]",
