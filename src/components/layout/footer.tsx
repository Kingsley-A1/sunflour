...
export function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-surface)]">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 lg:grid-cols-[1.25fr_0.75fr_0.75fr_1fr]">
        ...
        <section aria-labelledby="footer-contact">
          ...
          <ul className="m-0 mt-3 grid list-none gap-2 p-0">
            ...
            <li className="flex gap-2 rounded-[var(--radius-sm)] px-0 py-1.5 text-sm text-[var(--color-text-muted)]">
              <MapPin
                className="mt-0.5 h-4 w-4 shrink-0 text-[var(--color-primary)]"
                aria-hidden="true"
              />
    ...
    <li className="flex gap-2 rounded-[var(--radius-sm)] px-0 py-1.5 text-sm text-[var(--color-text-muted)]">
      ...
      <span>
        ...
        {item.href && item.value ? (
          <a
            className="inline-flex items-center gap-1 break-all hover:text-[var(--color-primary)] hover:underline"
            href={item.href}
