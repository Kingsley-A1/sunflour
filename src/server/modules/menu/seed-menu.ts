...
export const canonicalProductCategories = [
  {
    name: "Cakes",
    slug: "cakes",
    description: "Celebration cakes, sponge cakes, and bakery slices.",
    sortOrder: 10,
  },
  {
    name: "Pastries",
    slug: "pastries",
    description: "Meat pies, doughnuts, scotch biscuits, and sweet bites.",
    sortOrder: 20,
  },
  {
    name: "Burgers",
    slug: "burgers",
    description: "Beef, chicken, and Lebanese burgers.",
    sortOrder: 30,
  },
  {
    name: "Sandwiches",
    slug: "sandwiches",
    description: "Shawarma, fajita, and Lebanese sandwiches.",
    sortOrder: 40,
  },
  {
    name: "Pizza",
    slug: "pizza",
    description: "Regular and special pizzas in every size.",
    sortOrder: 50,
  },
  {
    name: "Protein",
    slug: "protein",
    description: "Peppered fried chicken and protein sides.",
    sortOrder: 60,
  },
  {
    name: "Chops",
    slug: "chops",
    description: "Small chops, samosa, spring rolls, and puff puff.",
    sortOrder: 70,
  },
  {
    name: "Ice Cream",
    slug: "ice-cream",
    description: "Ice cream cones, cups, and cold desserts.",
    sortOrder: 80,
  },
  {
    name: "Treats",
    slug: "treats",
    description: "Sweet bites and bakery treats.",
    sortOrder: 90,
  },
  {
    name: "Others",
